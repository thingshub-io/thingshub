...
public class InfoRequestProcessor implements Processor<Gb28181ChannelContext, InfoRequest> {

	@Override
	public void process(@NonNull Gb28181ChannelContext ctx, @NonNull InfoRequest request) {
		// TODO
	}
